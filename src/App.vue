<template>
  <v-app>
    ...
    <v-main>
      ...
      <h-crud searchable mode="cu" dialog-width="900px" :filter="filter" entity="user" header-align="end" item-label-key="name" :headers="headers" :edit-fields="search_fields" :search-fields="search_fields" :sort-key="sort_key" :sort-desc="sort_desc" :search-cols="4" :cols="6"></h-crud>
    </v-main>
  </v-app>
</template>
