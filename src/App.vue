<template>
  <v-app>
    ...
    <v-main>
      ...
      <h-crud searchable mode="crud" dialog-width="900px" entity="user" header-align="end" item-label-key="name" :sort-key="sort_key" :sort-desc="sort_desc" :search-cols="4" :cols="6"></h-crud>
    </v-main>
  </v-app>
</template>
