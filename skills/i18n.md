...
### Option 2: Use loadLocaleMessagesEager Helper

```typescript
import { loadLocaleMessagesEager, initApp } from "hola-web";
import holaEnMessages from "hola-web/locales/en.json";
import holaZhMessages from "hola-web/locales/zh.json";
...
const mergedMessages = {
  en: { ...holaEnMessages, ...appMessages.en },
  zh: { ...holaZhMessages, ...appMessages.zh },
};
...
If you want to customize or override specific hola-web messages, simply define the same keys in your locale file. Your messages will take precedence when merged after hola-web's defaults:
...
// App messages come LAST to override hola-web defaults
const mergedMessages = {
  en: { ...holaEnMessages, ...appMessages.en },
  zh: { ...holaZhMessages, ...appMessages.zh },
};
